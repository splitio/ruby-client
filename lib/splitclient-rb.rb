...
require 'splitclient-rb/helpers/api_helper'
...
require 'splitclient-rb/engine/api/json_localhost/segments'
require 'splitclient-rb/engine/api/json_localhost/splits'
