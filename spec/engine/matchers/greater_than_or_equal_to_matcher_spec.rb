...
describe SplitIoClient::GreaterThanOrEqualToMatcher do
  ...
  let(:date_splits_json) do
    File.read(File.expand_path(File.join(File.dirname(__FILE__),
                                         '../../test_data/splits/greater_than_or_equal_to_matcher/date_splits.json')))
  end
  let(:negative_splits_json) do
    File.read(
      File.expand_path(File.join(File.dirname(__FILE__),
                                 '../../test_data/splits/greater_than_or_equal_to_matcher/negative_splits.json'))
    )
  end
  let(:splits_json) do
    File.read(File.expand_path(File.join(File.dirname(__FILE__),
                                         '../../test_data/splits/greater_than_or_equal_to_matcher/splits.json')))
  end
